...
This included document receives values from the phase owner's retained `ResolvedProject`; use `bindings.vcs` and `bindings.workflow` and never resolve, infer, or read project policy.
