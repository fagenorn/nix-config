...
- Run the full suite as `WORKFLOW_POLICY_SURFACE=source just agent-workflow-tests`,
  ...
  1223 after Task 1 and 1227 after Task 4, with `skipped=2` throughout. A run
...
These figures are estimates. About 17 files change. The seven renames carry
...
`OK (skipped=2)`. All seven renames paired at 79–100%.
