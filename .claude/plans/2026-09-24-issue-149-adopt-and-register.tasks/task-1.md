...
.claude/specs and .out-of-scope under .agents/. Re-point the eight living
references to the classifier's destination paths, and name the rejection
binding in the adapter contract (spec D4).
